...
function register() {
	...
	xhr.onload = function() {
		if(xhr.readyState == 4 && xhr.status == 200) {
			...
			document.getElementById("formError").innerHTML = xhr.responseText;
		}
	};
	var user = document.userLogin.userName.value;
	var pass = document.userLogin.userPass.value;
	var conf = document.userLogin.passConf.value;
	var zip = document.userLogin.zip.value;
	if(user && pass && conf && zip) {
		xhr.send(encodeURI("userName="+user+"&userPass="+pass+"&passConf="+conf+"&zip="+zip));
	} else {
...
<div class="container-fluid">
			<div class="row">
				...
				<div class="col question col-6">
					<div id="login_panel">
					    <form name="userLogin" method="POST" onsubmit="event.preventDefault(); register();">
					    	...
					    	<input class="userForm"  name="passConf" type="text">
					    	<div>
					    	<div>Zip Code</div>
					    	<input class="userForm" name="zip" type="text">
					    	</div>
